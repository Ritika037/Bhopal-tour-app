...
import com.CR.examples.android.bhopaldarshan.Data.HotelData;
...
public class HotelFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getContext() != null) {
            ...
            recyclerView.setAdapter(new com.CR.examples.android.bhopaldarshan.Adapter.HotelAdapter(HotelData.fetchHotelData(getContext()), getContext()));
        }
    }
}